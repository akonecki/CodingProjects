public class ivq3 {
    ...
    public static void main(String [] args) {
        ...
        assert (!magicIndexExists(negativeArray));
        assert (!magicIndexExists(falseArray));
        assert (magicIndexExists(trueArrayStart));
        assert (magicIndexExists(trueArrayEnd));
        assert (magicIndexExists(trueArrayDup));
        assert (magicIndexExists(trueArrayDupPostOdd));
        assert (magicIndexExists(trueArrayDupPreOdd));
    }
}