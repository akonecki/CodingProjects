...
public class Solution {
    ...
    public static boolean checkSubtree(Node root1, Node root2) {
        // 1. will perform the BFS of tree 1.  
        // 2. when find value of a node that is equal to the value of root of tree2 then perform 
        //    DFS equal check.
        ...
        while (!currentLevel.isEmpty() || !nextLevel.isEmpty()) {
            if (!current.isEmpty()) {
                ...
                while (!currentLevel.isEmpty()) {
                    ...
                    // reactive - sanitity checks
                    assert (node != null);

                    // defensive
                    if (node != null) {
                        // push next level if left / right exists
                        if (node.left != null) {
                        ...
                        // need to look at current node and compare to root2
